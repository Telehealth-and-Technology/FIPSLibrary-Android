...
#copy assets  and lib files files for android projects
rsync -a dev/android-database-sqlcipher/libs* release/$ReleaseName/object/android
rsync -a dev/android-database-sqlcipher/assets* release/$ReleaseName/object/android


cp -r "dev/FipsWrapper/bin/fipswrapper.jar" "release/$ReleaseName/object/android/libs"
